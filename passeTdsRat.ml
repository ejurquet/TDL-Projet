...
struct
  ...
  (* listeTotaleIds : typ list -> string list *)
  (* Pramètre enums : liste de type *)
  (* Liste l'entièreté des ids contenus dans les enums passées en paramètres *)
  ...
  (* listeTotaleNomsEnums : typ list -> string list *)
  (* Paramètre enums : liste de type *)
  (* Liste l'entièreté des noms d'enums contenus dans les enums passées en paramètres *)
  ...
  (* elementsUniques : string list -> bool *)
  (* Paramètre enums : liste de string *)
  (* Indique si chaque élément de la liste est unique *)
  ...
  (* enumsCorrect : typ list -> bool *)
  (* Paramètre enums : liste de type *)
  (* Indique si les enums passées en paramètres sont cohérentes entre elles au sens de la passe TDS *)
  ...
  (* analyse_tds_affectable : tds -> AstSyntax.affectable -> bool -> affectable *)
  ...
  (* analyse_tds_listcase : tds -> AstSyntax.case list -> case list *) 
  and analyse_tds_listcase tds cl =
      List.map (analyse_tds_case tds) cl
      
  (* analyse_tds_case : tds -> AstSyntax.case -> case *)
  ...
  (* analyse_tds_break : AstSyntax.break -> break *)
  ...
  (* ajouterIdTDS : tds -> string -> info_ast *)
